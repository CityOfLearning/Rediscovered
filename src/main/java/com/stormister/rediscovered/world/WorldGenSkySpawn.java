...
public class WorldGenSkySpawn extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		if ((world.getBlockState(new BlockPos(x, y, z)) == Blocks.planks.getDefaultState())
				|| (world.getBlockState(new BlockPos(x, y, z)) == Blocks.log)
				|| (world.getBlockState(new BlockPos(x, y, z)) == Blocks.wool.getDefaultState())
				|| (world.getBlockState(new BlockPos(x, y, z)) == Blocks.cobblestone.getDefaultState())) {
			return false;
		}
		...
		// Contents of house
		world.setBlockState(new BlockPos(x + 2, y, z + 3),
				bed.getDefaultState().withProperty(BlockBed.PART, BlockBed.EnumPartType.FOOT)
						.withProperty(BlockDirectional.FACING, EnumFacing.WEST),
				3);
		world.setBlockState(new BlockPos(x + 1, y, z + 3),
				bed.getDefaultState().withProperty(BlockBed.PART, BlockBed.EnumPartType.HEAD)
						.withProperty(BlockDirectional.FACING, EnumFacing.WEST),
				1 + 3);
		world.setBlockState(new BlockPos(x + 1, y, z + 2), table.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z - 1),
				chair.getDefaultState().withProperty(BlockChair.FACING, EnumFacing.SOUTH), 3);
		...
		// door
		world.setBlockState(new BlockPos(x + 6, y, z + 1), door.getDefaultState()
				.withProperty(BlockDoor.HALF, EnumDoorHalf.LOWER).withProperty(BlockDoor.FACING, EnumFacing.WEST), 3);
		world.setBlockState(new BlockPos(x + 6, y + 1, z + 1), door.getDefaultState()
				.withProperty(BlockDoor.HALF, EnumDoorHalf.UPPER).withProperty(BlockDoor.FACING, EnumFacing.WEST), 3);
