...
public class ChunkProviderHeaven implements IChunkProvider {
	...
	public List getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
		BiomeGenBase var5 = worldObj.getBiomeGenForCoords(new BlockPos(par2, 64, par4));
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
		...
		BiomeGenBase biomegenbase = worldObj.getWorldChunkManager().getBiomeGenerator(new BlockPos(k + 16, 64, l + 16),
				null);
		...
		for (int j2 = 0; j2 < 20; j2++) {
			...
			(new WorldGenMinable(Blocks.dirt.getDefaultState(), 32)).generate(worldObj, rand,
					new BlockPos(l5, i9, k13));
		}
		...
		for (int j3 = 0; j3 < 20; j3++) {
			...
			(new WorldGenMinable(Blocks.iron_ore.getDefaultState(), 8)).generate(worldObj, rand,
					new BlockPos(k6, l9, j14));
		}
		...
		for (int k3 = 0; k3 < 2; k3++) {
			...
			(new WorldGenMinable(Blocks.gold_ore.getDefaultState(), 8)).generate(worldObj, rand,
					new BlockPos(l6, i10, k14));
		}
		...
		for (int i4 = 0; i4 < 1; i4++) {
			...
			(new WorldGenMinable(Blocks.diamond_ore.getDefaultState(), 7)).generate(worldObj, rand,
					new BlockPos(j7, k10, i15));
		}
		...
		for (int j4 = 0; j4 < 1; j4++) {
			...
			(new WorldGenMinable(Blocks.lapis_ore.getDefaultState(), 6)).generate(worldObj, rand,
					new BlockPos(k7, l10, j15));
		}
		...
		for (int i11 = 0; i11 < l7; i11++) {
			...
			worldgenerator.generate(worldObj, rand, new BlockPos(k15,
					worldObj.getChunkFromChunkCoords(k15 >> 4, j18 >> 4).getHeightValue(k15 & 15, j18 & 15), j18));
		}
		for (int i11 = 0; i11 < l7; i11++) {
			int k15 = k + rand.nextInt(16) + 8;
			int j18 = l + rand.nextInt(16) + 8;
			(new WorldGenCherryTrees(true)).generate(worldObj, rand, new BlockPos(k15,
					worldObj.getChunkFromChunkCoords(k15 >> 4, j18 >> 4).getHeightValue(k15 & 15, j18 & 15), j18));
		}
		...
		for (int j11 = 0; j11 < 2; j11++) {
			...
			(new WorldGenFlowers(Blocks.yellow_flower, EnumFlowerType.DANDELION)).generate(worldObj, rand,
					new BlockPos(l15, k18, i21));
		}
