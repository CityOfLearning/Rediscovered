...
public class WorldGenRose extends WorldGenerator {
	...
	public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
		for (int i = 0; i < 64; ++i) {
			BlockPos blockpos1 = p_180709_3_.add(p_180709_2_.nextInt(8) - p_180709_2_.nextInt(8),
			...
			if (worldIn.isAirBlock(blockpos1) && (!worldIn.provider.getHasNoSky() || (blockpos1.getY() < 255))
					&& worldIn.getBlockState(blockpos1.down()).getBlock().equals(Blocks.grass)) {
				worldIn.setBlockState(blockpos1, field_175915_b, 2);
			}
		}
	...
	public void setGeneratedBlock(Block p_175914_1_, BlockFlower.EnumFlowerType p_175914_2_) {
		field_175915_b = p_175914_1_.getDefaultState();
	}
}