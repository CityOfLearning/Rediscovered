...
public class RenderScarecrow extends RenderLiving {
	private static final ResourceLocation field_110920_a = new ResourceLocation(
			mod_Rediscovered.modid + ":" + "textures/models/Scarecrow.png");
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		renderChicken((EntityScarecrow) par1Entity, par2, par4, par6, par8, par9);
	}

	protected float getDeathMaxRotation(EntityLiving par1EntityLiving) {
		return getFishDeathRotation((EntityScarecrow) par1EntityLiving);
	}
	...
	protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return getSquidTextures((EntityScarecrow) par1Entity);
	}
	...
	public void renderChicken(EntityScarecrow par1EntityScarecrow, double par2, double par4, double par6, float par8,
			float par9) {
	...
	public void renderPlayer(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8,
			float par9) {
		renderChicken((EntityScarecrow) par1EntityLivingBase, par2, par4, par6, par8, par9);
	}
}
