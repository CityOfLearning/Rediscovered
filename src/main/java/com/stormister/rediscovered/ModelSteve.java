...
public class ModelSteve extends ModelBiped {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6) {
		...
		if (heldItemLeft != 0) {
			lefthand.rotateAngleX = (lefthand.rotateAngleX * 0.5F) - (((float) Math.PI / 10F) * heldItemLeft);
			lefttophand.rotateAngleX = (lefttophand.rotateAngleX * 0.5F) - (((float) Math.PI / 10F) * heldItemLeft);
			leftarm.rotateAngleX = (leftarm.rotateAngleX * 0.5F) - (((float) Math.PI / 10F) * heldItemLeft);
		}

		if (heldItemRight != 0) {
			righthand.rotateAngleX = (righthand.rotateAngleX * 0.5F) - (((float) Math.PI / 10F) * heldItemRight);
			righttophand.rotateAngleX = (righttophand.rotateAngleX * 0.5F) - (((float) Math.PI / 10F) * heldItemRight);
