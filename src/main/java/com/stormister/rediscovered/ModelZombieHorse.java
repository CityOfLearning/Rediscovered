...
public class ModelZombieHorse extends ModelBase {
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
		...
		float f5 = par1EntityLivingBase.prevRotationPitch
				+ ((par1EntityLivingBase.rotationPitch - par1EntityLivingBase.prevRotationPitch) * par4);
		float f6 = f4 - f3;
		...
		field_110709_a.rotateAngleX = (f9 * (0.2617994F + f7)) + (f8 * 2.18166F)
				+ ((1.0F - Math.max(f9, f8)) * field_110709_a.rotateAngleX);
		field_110709_a.rotateAngleY = (f9 * (f6 / (180F / (float) Math.PI)))
				+ ((1.0F - Math.max(f9, f8)) * field_110709_a.rotateAngleY);
		field_110709_a.rotationPointY = (f9 * -6.0F) + (f8 * 11.0F)
				+ ((1.0F - Math.max(f9, f8)) * field_110709_a.rotationPointY);
		field_110709_a.rotationPointZ = (f9 * -1.0F) + (f8 * -10.0F)
				+ ((1.0F - Math.max(f9, f8)) * field_110709_a.rotationPointZ);
		...
		field_110719_v.rotationPointY = field_110711_o.rotationPointY
				+ (MathHelper.sin(((float) Math.PI / 2F) + f18 + (f10 * -f13 * 0.5F * par3)) * 7.0F);
		field_110719_v.rotationPointZ = field_110711_o.rotationPointZ
				+ (MathHelper.cos((((float) Math.PI * 3F) / 2F) + f18 + (f10 * -f13 * 0.5F * par3)) * 7.0F);
		field_110721_y.rotationPointY = field_110722_x.rotationPointY
				+ (MathHelper.sin(((float) Math.PI / 2F) + f18 + (f10 * f13 * 0.5F * par3)) * 7.0F);
		field_110721_y.rotationPointZ = field_110722_x.rotationPointZ
				+ (MathHelper.cos((((float) Math.PI * 3F) / 2F) + f18 + (f10 * f13 * 0.5F * par3)) * 7.0F);
		float f20 = ((-1.0471976F + f19) * f9) + (f14 * f10);
		float f21 = ((-1.0471976F + -f19) * f9) + (-f14 * f10);
		field_110689_B.rotationPointY = field_110688_A.rotationPointY
				+ (MathHelper.sin(((float) Math.PI / 2F) + f20) * 7.0F);
		field_110689_B.rotationPointZ = field_110688_A.rotationPointZ
				+ (MathHelper.cos((((float) Math.PI * 3F) / 2F) + f20) * 7.0F);
		field_110685_E.rotationPointY = field_110684_D.rotationPointY
				+ (MathHelper.sin(((float) Math.PI / 2F) + f21) * 7.0F);
		field_110685_E.rotationPointZ = field_110684_D.rotationPointZ
				+ (MathHelper.cos((((float) Math.PI * 3F) / 2F) + f21) * 7.0F);
		field_110711_o.rotateAngleX = f18 + (-f13 * 0.5F * par3 * f10);
		field_110719_v.rotateAngleX = (-0.08726646F * f9)
				+ (((-f13 * 0.5F * par3) - Math.max(0.0F, f13 * 0.5F * par3)) * f10);
		field_110718_w.rotateAngleX = field_110719_v.rotateAngleX;
		field_110722_x.rotateAngleX = f18 + (f13 * 0.5F * par3 * f10);
		field_110721_y.rotateAngleX = (-0.08726646F * f9)
				+ (((f13 * 0.5F * par3) - Math.max(0.0F, -f13 * 0.5F * par3)) * f10);
		field_110720_z.rotateAngleX = field_110721_y.rotateAngleX;
		field_110688_A.rotateAngleX = f20;
		field_110689_B.rotateAngleX = ((field_110688_A.rotateAngleX
				+ ((float) Math.PI * Math.max(0.0F, 0.2F + (f19 * 0.2F)))) * f9)
				+ ((f14 + Math.max(0.0F, f13 * 0.5F * par3)) * f10);
		field_110690_C.rotateAngleX = field_110689_B.rotateAngleX;
		field_110684_D.rotateAngleX = f21;
		field_110685_E.rotateAngleX = ((field_110684_D.rotateAngleX
				+ ((float) Math.PI * Math.max(0.0F, 0.2F - (f19 * 0.2F)))) * f9)
				+ ((-f14 + Math.max(0.0F, -f13 * 0.5F * par3)) * f10);
