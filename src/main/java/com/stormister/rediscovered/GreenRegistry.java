		...
		private static final ITradeList[][][][] trades = {
				{ { { new EmeraldForItems(Items.wheat, new PriceInfo(18, 22)),
						...
						{ { new EmeraldForItems(Items.string, new PriceInfo(15, 20)),
								...
								new ItemAndEmeraldToItem(Items.fish, new PriceInfo(6, 6), Items.cooked_fish,
										new PriceInfo(6, 6)) },
						...
						{ { new EmeraldForItems(Item.getItemFromBlock(Blocks.wool), new PriceInfo(16, 22)),
								new ListItemForEmeralds(Items.shears, new PriceInfo(3, 4)) }, {
										...
										new ListItemForEmeralds(new ItemStack(Blocks.wool, 1, 15),
												new PriceInfo(1, 2)) } },
						{ { new EmeraldForItems(Items.string, new PriceInfo(15, 20)),
				...
				{ { { new EmeraldForItems(Items.paper, new PriceInfo(24, 36)), new ListEnchantedBookForEmeralds() },
						...
						{ new ListEnchantedBookForEmeralds() }, { new ListEnchantedBookForEmeralds() },
